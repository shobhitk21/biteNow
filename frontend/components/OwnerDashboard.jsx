...
const OwnerDashboard = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-bgColor flex flex-col items-center'>
      <Nav />
      {
        !myShopData && <div className='flex justify-center items-center p-4 sm:p-6'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              <FaUtensils className='text-primaryColor w-16 h-16 sm:w-20 sm:h-20 mb-4' />
              ...
              <button onClick={() => navigate("/create-edit-shop")} className='bg-primaryColor text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-hoverColor cursor-pointer transition-colors duration-200'>
                Get Started
              </button>
      ...
      }
      {
        myShopData && <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6 '>
          ...
          <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
            <div className='absolute top-4 right-4 bg-primaryColor text-white p-2 rounded-full hover:bg-orange-600 cursor-pointer transition-colors' onClick={() => navigate("/create-edit-shop")}>
              <FaPen size={20} />
            </div>
              ...
              <div className='flex justify-center items-center p-4 sm:p-6'>
                <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                  <div className='flex flex-col items-center text-center'>
                    ...
                    <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                      Share you delicious creations with our customers by adding them to menu
                    </p>
                    <button onClick={() => navigate("/add-item")} className='bg-primaryColor text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-hoverColor cursor-pointer transition-colors duration-200'>
                      Add Food
                    </button>
